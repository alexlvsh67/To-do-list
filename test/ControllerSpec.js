...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show all entries without "all" route', function () {
		  ...
		  // 2) devrait montrer les entrées active
		it('should show active entries', function () {
           ...
           // 3) devrait montrer les entrées complétés
	...
	it('should set the "clear completed" button', function () {
      ...
      // 4) devrait mettre en évidence le filtre "All" par défaut
	it('should highlight "All" filter by default', function () {
      ...
      // 5) devrait mettre en évidence le filtre "Actif" quand on est sur la page "#/active"
	...
	describe('toggle all', function () {
		...
		// 6) devrait mettre a jour toutes les taches à "completed"
		it('should toggle all todos to completed', function () {
			// TODO: write test

			var todos = [{id: 42,title: 'my todo',completed: true},
						 {id: 21,title: 'my todo 2',completed: true}];
		...
		// 7) devrait mettre à jour la vue
	...
	describe('new todo', function () {
		  ...
		  // 8) devrait ajouter un nouveau todo au modèle
	...
	describe('element removal', function () {
		...
		// 9) devrait supprimer une entrée du modèle
