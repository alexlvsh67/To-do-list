...
.book-cover .book-cover-spine-image,
.book-cover .book-cover-back-image {
  visibility: hidden;
}
.book-cover-overlay,
...
.book-cover-inner.hover-ok:hover {
  transform: rotate3d(0, 1, 0, 35deg);
}
.book-cover-inner.flipped {
  transform: translate3d(0, 0, 0px) rotate3d(0, 1, 0, 180deg);
}
.book-cover-inner.flipped.hover-ok:hover {
...
.book-cover.activated .book-cover-front-outside {
  box-shadow: none;
}
